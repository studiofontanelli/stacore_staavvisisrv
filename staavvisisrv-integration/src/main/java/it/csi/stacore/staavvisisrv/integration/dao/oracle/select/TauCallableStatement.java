 ...
 * @version $Revision$
 */
public class TauCallableStatement extends TauPreparedStatement {
  //~ Constructors =============================================================

  /**
   * Creates a new TauCallableStatement object.
   *
   * @param connection
   * @param query
   *
   * @throws SQLException
   */
  public TauCallableStatement(Connection connection, String query)
                          throws SQLException {
    super();
